...
import Rollcok from '../assets/images/rollcok.png';
import Milmol from '../assets/images/milmol.png';
import Chimil from '../assets/images/chimil.png';
import Thairoll from '../assets/images/thairoll.png';
import Molthai from '../assets/images/molthai.png';
import Thaichick from '../assets/images/thaichick.png';
import { useNavigate } from 'react-router';
import { Sparkles, Heart, Utensils, Info, Mail,ShoppingCart } from 'lucide-react';
  ...
  const menuItems = [
    {
      ...
      name: 'THAI ROLL',
      price: 20000,
      description: 'Thai Tea dengan kombinasi makanan mie roll yang pedas dan lezat.',
      image: Thairoll,
      taste: 70,
      spicy: 90
    },
    {
      ...
      name: 'MOLTHAI',
      price: 20000,
      description: 'Thai Tea dengan kombinasi makanan cimol yang asin dan kenyal.',
      image: Molthai,
      taste: 70,
      spicy: 50
    },
    {
      ...
      name: 'THAICHICK',
      price: 20000,
      description: 'Thai Tea dengan kombinasi makanan chicken popcorn yang crunchy.',
      image: Thaichick,
      taste: 70,
      spicy: 60
    },
    {
      ...
      name: 'ROLLCOK',
      price: 20000,
      description: 'Milo Segar dengan kombinasi makanan mie roll yang pedas dan lezat.',
      image: Rollcok,
      taste: 90,
      spicy: 90
    },
    {
      ...
      name: 'MILMOL',
      price: 20000,
      description: 'Milo Segar dengan kombinasi makanan cimol yang asin dan kenyal.',
      image: Milmol,
      taste: 90,
      spicy: 50
    },
    {
      ...
      name: 'CHIMIL',
      price: 20000,
      description: 'Milo Segar dengan kombinasi makanan chicken popcorn yang crunchy.',
      image: Chimil,
      taste: 90,
      spicy: 60
    }
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <button 
                ...
                className="bg-white cursor-pointer border-2 border-black px-3 py-2 hover:bg-[#FFFFB0] transition-colors pixel-box-shadow flex items-center gap-2"
              >
                <Info className="w-3 h-3 sm:w-4 sm:h-4" />
                <span className="text-[10px] sm:text-xs text-[#FF9B00] hidden sm:inline">ABOUT</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-[10px] sm:text-xs text-[#FF9B00] hidden sm:inline">CONTACT</span>
              </button>
              <button 
                onClick={() => navigate('/cart')}
                className="bg-[#FFFFB0] cursor-pointer border-2 border-black px-3 py-2 hover:bg-white transition-colors pixel-box-shadow flex items-center gap-2 relative"
              >
                <ShoppingCart className="w-4 h-4 text-[#FF9B00]" />
                {getTotalItems() > 0 && (
                  <div className="absolute -top-2 -right-2 bg-red-600 border-2 border-black w-6 h-6 rounded-full flex items-center justify-center animate-pulse">
                    <span className="text-[10px] text-white">{getTotalItems()}</span>
                  </div>
                )}
              </button>
            </div>
          ...
          <div id="about" className="mb-16 scroll-mt-32">
            <div className="text-center mb-8">
              <div className="inline-block bg-[#FFFFB0] border-4 border-black px-6 py-3 pixel-box-shadow">
                <h2 className="text-lg sm:text-xl text-[#FF9B00]">★ TENTANG KAMI ★</h2>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#1a1a2e] border-2 border-[#FF9B00] p-6">
                    <p className="text-xs sm:text-sm text-white leading-relaxed mb-4">
                      TR3Y Snack & Sip adalah usaha kuliner yang menghadirkan konsep tray kekinian dengan perpaduan minuman dan camilan favorit dalam satu paket praktis dan menarik. Kami fokus menyajikan pengalaman makan yang simple, enak, dan cocok dinikmati kapan saja—baik sendiri maupun bersama teman.
                    </p>
                    <p className="text-xs sm:text-sm text-white leading-relaxed mb-4">
                      Setiap tray kami berisi pilihan minuman segar seperti Thai Tea dan Milo yang creamy, dipadukan dengan aneka makanan lezat seperti roll samyang yang pedas menggoda, ayam popcorn yang gurih renyah, serta cimol yang kenyal dan nikmat. Semua disajikan dalam satu tray yang variatif dan memuaskan.
                    </p>
                    <p className="text-xs sm:text-sm text-white leading-relaxed">
                        Kami berkomitmen untuk menggunakan bahan berkualitas, menjaga cita rasa, dan memberikan pelayanan terbaik agar setiap pelanggan mendapatkan pengalaman yang menyenangkan dari setiap pembelian.
                    </p>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="bg-[#00ff0da9] border-4 border-black p-4 text-center">
            ...
            <div className="text-center">
              <div className="bg-black border-4 border-white p-6 max-w-xl mx-auto pixel-box-shadow">
                <div className="space-y-4">
                  ...
                  <div className="pt-2">
                    <p className="text-[10px] text-gray-400">WhatsApp: +62 855 1986 961 (MAS LEDO)</p>
                  </div>
                </div>
              </div>
            </div>
